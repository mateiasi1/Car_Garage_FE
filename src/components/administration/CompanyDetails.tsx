        ...
        <div className="space-y-6">
            <div className="bg-card rounded-lg shadow-md p-6">
                ...
                <div className="flex flex-col border-l-4 border-primary">
                    <div className="flex items-center gap-3 pl-4 py-2 hover:bg-background transition-colors duration-200">
                        <span className="font-semibold font-heading w-48 text-text">
                            {t('name')}:
                        </span>
            ...
            <div className="bg-card rounded-lg shadow-md p-6 max-w-md">
                {activePackage ? (
                    <>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between py-2 border-b border-gray-200">
                                ...
                                <span className="font-semibold font-heading text-text">
                                    {activePackage.package?.name || 'N/A'}
                                </span>
                            </div>

                            <div className="flex items-center justify-between py-2 border-b border-gray-200">
                                <span className="text-sm font-body text-gray-600">
                                    {t('packages.totalMessages')}:
                                </span>
                                <span className="font-semibold font-heading text-text">
                            ...
                            <div className="flex items-center justify-between py-2 border-b border-gray-200">
                                <span className="text-sm font-body text-gray-600">
                                    {t('packages.usedMessages')}:
                                </span>
                                <span className="font-semibold font-heading text-text">
                                    {activePackage.usage?.sms?.used || 0}
                                </span>
                            </div>

                            <div className="flex items-center justify-between py-2">
                                <span className="text-sm font-body text-gray-600">
                                    {t('packages.expiryDate')}:
                                </span>
                                <span className="font-semibold font-heading text-text">
