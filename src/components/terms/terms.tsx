      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-lg shadow-md p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 font-body mb-4">{t('terms.sections.intro.content.p1')}</p>
            <p className="text-gray-700 font-body">{t('terms.sections.intro.content.p2')}</p>
          </section>

          {/* Service Description */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold font-heading text-text mb-4">{t('terms.sections.service.title')}</h2>
            <p className="text-gray-700 font-body mb-4">{t('terms.sections.service.content.p1')}</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 font-body mb-4">{t('terms.sections.data.content.p1')}</p>
            ...
            <p className="text-gray-700 font-body">{t('terms.sections.data.content.p2')}</p>
          </section>
          ...
          <section className="mb-8 bg-blue-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700 font-body">{t('terms.sections.gdpr.legal.content')}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 font-body">{t('terms.sections.gdpr.retention.content')}</p>
              </div>

              <div>
                <h3 className="font-semibold font-heading text-text mb-2">{t('terms.sections.gdpr.security.title')}</h3>
                <p className="text-gray-700 font-body">{t('terms.sections.gdpr.security.content')}</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 font-body mb-4">{t('terms.sections.security.content.p1')}</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 font-body ml-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 font-body">{t('terms.sections.liability.content')}</p>
          </section>

          {/* Changes to Terms */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold font-heading text-text mb-4">{t('terms.sections.changes.title')}</h2>
            <p className="text-gray-700 font-body">{t('terms.sections.changes.content')}</p>
          </section>

          {/* Contact */}
          <section className="mb-8 bg-gray-50 p-6 rounded-lg">
            <h2 className="text-2xl font-bold font-heading text-text mb-4">{t('terms.sections.contact.title')}</h2>
            <p className="text-gray-700 font-body mb-4">{t('terms.sections.contact.content')}</p>
          ...
          <div className="border-t-2 border-gray-200 pt-6">
            <p className="text-gray-700 font-body font-semibold">{t('terms.agreement')}</p>
          </div>
        </div>
      </main>
