    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-primary to-sidebar text-primary-text flex flex-col">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            <div className="bg-card rounded-3xl shadow-md p-6 flex flex-col gap-3 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-lg font-heading font-semibold text-text">{t('home.features.stations.title')}</h3>
              <p className="text-sm text-gray-600 font-body">{t('home.features.stations.description')}</p>
            </div>
            ...
            <div className="bg-card rounded-3xl shadow-md p-6 flex flex-col gap-3 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-lg font-heading font-semibold text-text">{t('home.features.inspections.title')}</h3>
              <p className="text-sm text-gray-600 font-body">{t('home.features.inspections.description')}</p>
            </div>
            ...
            <div className="bg-card rounded-3xl shadow-md p-6 flex flex-col gap-3 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-lg font-heading font-semibold text-text">{t('home.features.notifications.title')}</h3>
              <p className="text-sm text-gray-600 font-body">{t('home.features.notifications.description')}</p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-card/95 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-600 font-body text-sm sm:text-base">
          <div className="text-center md:text-left">© 2025 RoadReady. {t('home.footer.rights')}</div>
