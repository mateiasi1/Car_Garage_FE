...
export const PhoneNumberRoInput: FC<PhoneNumberRoInputProps> = ({ value, onChange, className = '' }) => {
  ...
  return (
    ...
    >
      <img src={flagRo} alt="Romania flag" className="w-5 h-5 mr-2 rounded-sm object-cover" />
