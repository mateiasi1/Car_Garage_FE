...
const InspectionForm: FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-background p-6">
      <div className="w-full bg-white rounded-xl shadow-md p-6 mt-12 h-[calc(100vh-6rem)] flex flex-col">
        <h2 className="text-2xl font-heading text-center mb-8">{t('addNewInspection')}</h2>
